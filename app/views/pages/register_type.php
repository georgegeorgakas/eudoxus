...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            <div class="lol">
                <p class="btn btn-primary btn-lg btn-block">ΕΓΓΡΑΦΗ ΣΤΗΝ ΕΦΑΡΜΟΓΗ</p>
                <a href="<?php echo URLROOT; ?>/users/register/student" type="button" class="btn btn-default btn-lg btn-block">Ως Φοιτητής</a>
                <a href="<?php echo URLROOT; ?>/users/register/employee" type="button" class="btn btn-default btn-lg btn-block">Ως Γραμματεία</a>
                <a href="<?php echo URLROOT; ?>/users/register/employee" type="button" class="btn btn-default btn-lg btn-block">Ως Εκδότης</a>
            </div>
        </div>
    </div>
</div>
